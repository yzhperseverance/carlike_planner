...
if("TRUE" STREQUAL "TRUE")
  set(mpc_controller_SOURCE_PREFIX /home/yzh/导航框架/uneven_planner/src/uneven_planner/mpc_controller)
  set(mpc_controller_DEVEL_PREFIX /home/yzh/导航框架/uneven_planner/devel)
  ...
  set(mpc_controller_INSTALL_PREFIX /home/yzh/导航框架/uneven_planner/install)
...
if(NOT "/home/yzh/导航框架/uneven_planner/devel/include " STREQUAL " ")
  set(mpc_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/yzh/导航框架/uneven_planner/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yzh/导航框架/uneven_planner/src/uneven_planner/mpc_controller/${idir}'.  ${_report}")
    endif()
...
set(mpc_controller_EXPORTED_TARGETS "mpc_controller_generate_messages_cpp;mpc_controller_generate_messages_eus;mpc_controller_generate_messages_lisp;mpc_controller_generate_messages_nodejs;mpc_controller_generate_messages_py")
...
set(pkg_cfg_extras "mpc_controller-msg-extras.cmake")
